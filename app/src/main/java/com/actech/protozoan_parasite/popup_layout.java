    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     switch(id){
            case 1:
                ...
                break;
                default:
                    Toast.makeText(getApplicationContext(),"click something",Toast.LENGTH_SHORT).show();
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent2.putExtra("sub_id","morpho");
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(popup_layout.this,"button clicked" + id,Toast.LENGTH_SHORT).show();
                intent2.putExtra("id",id);
                intent2.putExtra("sub_id","immuno");
                startActivity(intent2);
                finish();
